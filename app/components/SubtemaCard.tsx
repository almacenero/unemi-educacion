...
export default function SubtemaCard({ unidadId, subtemaId, titulo }: SubtemaCardProps) {
  return (
    <Link 
      ...
      className="group block bg-white rounded-lg shadow-sm hover:shadow-lg transition-all duration-200 p-5 border border-gray-200 hover:border-blue-400 hover:-translate-y-0.5"
    >
